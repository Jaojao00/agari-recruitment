...
export async function addRowToSheet(application: Application): Promise<number | null> {
  ...
  const row = [
    ...
    application.appliedAt ? new Date(application.appliedAt._seconds * 1000).toLocaleString('vi-VN') : '',
    application.status,
    application.hiredAt ? new Date(application.hiredAt._seconds * 1000).toLocaleDateString('vi-VN') : '',
    application.expiredAt ? new Date(application.expiredAt._seconds * 1000).toLocaleDateString('vi-VN') : '',
    application.note || '',
...
export async function updateRowInSheet(application: Application, rowNumber: number) {
