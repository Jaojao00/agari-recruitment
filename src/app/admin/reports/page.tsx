...
export default function ReportsPage() {
  ...
  const handleExport = () => {
    // Navigation is intentional here so the browser downloads the generated file.
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 max-w-xl">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-500 italic mt-2">
            File Excel sẽ bao gồm toàn bộ các trường dữ liệu và được format sẵn
            theo tiêu chuẩn báo cáo. Dữ liệu CCCD/SĐT sẽ được định dạng Text để
            không bị mất số 0 đầu hoặc chuyển thành E+.
          </p>
        </div>
      </div>
    </div>
