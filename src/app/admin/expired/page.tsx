  ...
  return (
    <div className="space-y-4">
       <div className="flex items-center gap-4">
         ...
         <span className="bg-red-100 text-red-700 px-3 py-1 rounded-full text-sm font-semibold">Cảnh báo: Hồ sơ đã hết hạn</span>
       </div>
          ...
          <TableBody>
            {data.map(app => (
              <TableRow key={app.id}>
                ...
                <TableCell>{app.expiredAt ? new Date(app.expiredAt._seconds * 1000).toLocaleDateString('vi-VN') : '-'}</TableCell>
                <TableCell>
