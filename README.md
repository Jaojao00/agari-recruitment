...
```
*Lưu ý: Bạn cần share quyền Edit Google Sheet của bạn cho `GOOGLE_SERVICE_ACCOUNT_EMAIL`.*
...
- Khi hồ sơ được submit hoặc được Admin cập nhật, hệ thống ghi nhận vào Firestore trước, sau đó tạo 1 record vào `sync_queue`.
